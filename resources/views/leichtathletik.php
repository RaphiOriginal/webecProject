...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Leichtathletik
                </h1>
                <ol class="breadcrumb">
                    <li><a href="/">TV Welschenrohr</a>
                    </li>
                    <li class="active">Leichtathletik</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <?php 
                    $picture = DB::table('department')->where('id', '2')->first();
                ...
                <table class="table">
                    ...
                    //TODO implement correct query
                        //$members = DB::table('member')->join('has_member', 'member.id', '=', 'has_member.member')->select('member.prename', 'member.name', 'member.email')->where('has_member.department', "=", '2')->get();
